...
public abstract class WorkDocument {
	...
	public WorkDocument (Framework framework) throws DocumentOpenFailedException {
		this.framework = framework;
	}

	public WorkDocument (Framework framework, Element xmlRootElement) {
