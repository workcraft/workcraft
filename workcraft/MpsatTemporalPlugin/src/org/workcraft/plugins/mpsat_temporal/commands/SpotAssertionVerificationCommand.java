package org.workcraft.plugins.mpsat_temporal.commands;
...
import org.workcraft.plugins.mpsat_temporal.tasks.SpotChainTask;
...
public class SpotAssertionVerificationCommand extends AbstractVerificationCommand
    ...
    public MenuVisibility getMenuVisibility() {
        return MpsatTemporalSettings.getShowSpotInMenu() ? MenuVisibility.ACTIVE_APPLICABLE : MenuVisibility.NEVER;
    }
