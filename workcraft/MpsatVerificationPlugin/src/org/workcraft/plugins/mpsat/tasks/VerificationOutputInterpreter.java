...
public class VerificationOutputInterpreter extends AbstractOutputInterpreter<VerificationOutput, Boolean> {
    ...
    VerificationOutputInterpreter(WorkspaceEntry we, ExportOutput exportOutput,
            PcompOutput pcompOutput, VerificationOutput mpsatOutput,
