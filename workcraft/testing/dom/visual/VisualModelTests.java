...
public class VisualModelTests {
	...
	@Test
	public void TestGroupWithEmptySelection() throws VisualModelConstructionException
	{
	...
	{
		VisualNode [] diffs = new VisualNode [oldNodes.length - (newNodes.length-1)];
	...
	public void TestGroup1Item() throws VisualModelConstructionException
	{
		...
		TestGroup(model, new VisualNode[]{node1});
	}
	...
	public void TestGroup5Items() throws VisualModelConstructionException
	{
		...
		SquareNode sq1 = new SquareNode(root, new Rectangle2D.Double(0, 0, 1, 1));
		SquareNode sq2 = new SquareNode(root, new Rectangle2D.Double(0, 0, 1, 1));
		SquareNode sq3 = new SquareNode(root, new Rectangle2D.Double(0, 0, 1, 1));
		SquareNode sq4 = new SquareNode(root, new Rectangle2D.Double(0, 0, 1, 1));
		SquareNode sq5 = new SquareNode(root, new Rectangle2D.Double(0, 0, 1, 1));
