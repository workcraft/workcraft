...
public class FunctionDeserialiser implements CustomXMLDeserialiser<FunctionContact> {
    ...
    public void finaliseInstance(Element element, FunctionContact instance, ReferenceResolver internalReferenceResolver,
        ...
        BooleanFormula setFormula = BooleanFunctionDeserialiser.parseFormula(setString, internalReferenceResolver);
        ...
        BooleanFormula resetFormula = BooleanFunctionDeserialiser.parseFormula(resetString, internalReferenceResolver);
