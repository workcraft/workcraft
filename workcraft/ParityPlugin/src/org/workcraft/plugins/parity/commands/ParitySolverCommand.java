...
public class ParitySolverCommand extends AbstractGameSolverCommand {
	...
	public void colorNodesRed (Collection<VisualPlayer0> p0nodes, 
		...
		if (p0nodes == null) {
			p0nodes = new ArrayList<VisualPlayer0>();
		}
		if (p1nodes == null) {
			p1nodes = new ArrayList<VisualPlayer1>();
		}
	...
	public void colorEdgesRed(Collection<VisualConnection> edges) {
		...
		if (edges == null) {
			edges = new ArrayList<VisualConnection>();
		}
	...
	public void colorWinningRegions (ArrayList<OinkOutputNode> outputNodes,
		...
		ArrayList<VisualPlayer0> p0win = new ArrayList<VisualPlayer0>();
		ArrayList<VisualPlayer0> p0lose = new ArrayList<VisualPlayer0>();
		ArrayList<VisualPlayer1> p1win = new ArrayList<VisualPlayer1>();
		ArrayList<VisualPlayer1> p1lose = new ArrayList<VisualPlayer1>();
		ArrayList<VisualConnection> p0strategy = new ArrayList<VisualConnection>();
		ArrayList<VisualConnection> p1strategy = new ArrayList<VisualConnection>();
		...
		while(p0iter.hasNext()) {
			...
			if (tempOutput.getWonByPlayer1() == true) {
		...
		while (outputNodeiter.hasNext()) {
			...
			while (edgeIter.hasNext()) {
				...
				if (tempOutput.getId() == srcNode && 
					...
					if (tempOutput.getWonByPlayer1() == false) {
    ...
    public String getGameSolver(WorkspaceEntry we) {
		...
		if (pg.isInfinite(inputNodes) == false) {
