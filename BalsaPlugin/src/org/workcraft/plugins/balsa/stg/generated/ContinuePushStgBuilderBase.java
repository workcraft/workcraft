...
public abstract class ContinuePushStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<ContinuePushStgBuilderBase.ContinuePush, ContinuePushStgBuilderBase.ContinuePushHandshakes> {
    ...
    public static final class ContinuePushHandshakesEnv {

        public ContinuePushHandshakesEnv(ContinuePush component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
