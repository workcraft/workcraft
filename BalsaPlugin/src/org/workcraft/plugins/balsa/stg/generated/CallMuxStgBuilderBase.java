...
public abstract class CallMuxStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<CallMuxStgBuilderBase.CallMux, CallMuxStgBuilderBase.CallMuxHandshakes> {
    ...
    public static final class CallMuxHandshakesEnv {

        public CallMuxHandshakesEnv(CallMux component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
            inp = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.array(handshakes, "inp", component.inputCount, org.workcraft.plugins.balsa.handshakestgbuilder.ActivePushStg.class);
        ...
        public final java.util.List<org.workcraft.plugins.balsa.handshakestgbuilder.ActivePushStg> inp;
