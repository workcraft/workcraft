...
public abstract class ForkPushStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<ForkPushStgBuilderBase.ForkPush, ForkPushStgBuilderBase.ForkPushHandshakes> {
    ...
    public static final class ForkPushHandshakesEnv {

        public ForkPushHandshakesEnv(ForkPush component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
