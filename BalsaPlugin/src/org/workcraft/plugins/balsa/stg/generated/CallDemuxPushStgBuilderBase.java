...
public abstract class CallDemuxPushStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<CallDemuxPushStgBuilderBase.CallDemuxPush, CallDemuxPushStgBuilderBase.CallDemuxPushHandshakes> {
    ...
    public static final class CallDemuxPushHandshakesEnv {

        public CallDemuxPushHandshakesEnv(CallDemuxPush component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
            ...
            out = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.array(handshakes, "out", component.outputCount, org.workcraft.plugins.balsa.handshakestgbuilder.PassivePushStg.class);
        }

        public final org.workcraft.plugins.balsa.handshakestgbuilder.ActivePushStg inp;

        public final java.util.List<org.workcraft.plugins.balsa.handshakestgbuilder.PassivePushStg> out;
    }
