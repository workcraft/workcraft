...
public abstract class ForkStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<ForkStgBuilderBase.Fork, ForkStgBuilderBase.ForkHandshakes> {
    ...
    public static final class ForkHandshakesEnv {

        public ForkHandshakesEnv(Fork component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
