...
public abstract class HaltPushStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<HaltPushStgBuilderBase.HaltPush, HaltPushStgBuilderBase.HaltPushHandshakes> {
    ...
    public static final class HaltPushHandshakesEnv {

        public HaltPushHandshakesEnv(HaltPush component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
