...
public abstract class ContinueStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<ContinueStgBuilderBase.Continue, ContinueStgBuilderBase.ContinueHandshakes> {
    ...
    public static final class ContinueHandshakesEnv {

        public ContinueHandshakesEnv(Continue component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
