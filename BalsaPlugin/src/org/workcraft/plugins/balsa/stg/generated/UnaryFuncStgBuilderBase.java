...
public abstract class UnaryFuncStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<UnaryFuncStgBuilderBase.UnaryFunc, UnaryFuncStgBuilderBase.UnaryFuncHandshakes> {
    ...
    public static final class UnaryFuncHandshakesEnv {

        public UnaryFuncHandshakesEnv(UnaryFunc component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
