...
public abstract class HaltStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<HaltStgBuilderBase.Halt, HaltStgBuilderBase.HaltHandshakes> {
    ...
    public static final class HaltHandshakesEnv {

        public HaltHandshakesEnv(Halt component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
