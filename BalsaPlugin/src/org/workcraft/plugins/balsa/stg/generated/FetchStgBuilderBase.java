...
public abstract class FetchStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<FetchStgBuilderBase.Fetch, FetchStgBuilderBase.FetchHandshakes> {
    ...
    public static final class FetchHandshakesEnv {

        public FetchHandshakesEnv(Fetch component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
