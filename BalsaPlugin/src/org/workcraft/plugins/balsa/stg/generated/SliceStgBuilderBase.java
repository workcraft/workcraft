...
public abstract class SliceStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<SliceStgBuilderBase.Slice, SliceStgBuilderBase.SliceHandshakes> {
    ...
    public static final class SliceHandshakesEnv {

        public SliceHandshakesEnv(Slice component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
