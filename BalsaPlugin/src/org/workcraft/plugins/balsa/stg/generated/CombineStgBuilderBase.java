...
public abstract class CombineStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<CombineStgBuilderBase.Combine, CombineStgBuilderBase.CombineHandshakes> {
    ...
    public static final class CombineHandshakesEnv {

        public CombineHandshakesEnv(Combine component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
            ...
            LSInp = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.get(handshakes, "LSInp", org.workcraft.plugins.balsa.handshakestgbuilder.PassivePullStg.class);
            MSInp = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.get(handshakes, "MSInp", org.workcraft.plugins.balsa.handshakestgbuilder.PassivePullStg.class);
        }

        public final org.workcraft.plugins.balsa.handshakestgbuilder.ActivePullStg out;

        public final org.workcraft.plugins.balsa.handshakestgbuilder.PassivePullStg LSInp;

        public final org.workcraft.plugins.balsa.handshakestgbuilder.PassivePullStg MSInp;
    }
