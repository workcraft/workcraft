...
public abstract class DecisionWaitStgBuilderBase extends org.workcraft.plugins.balsa.stg.GeneratedComponentStgBuilder<DecisionWaitStgBuilderBase.DecisionWait, DecisionWaitStgBuilderBase.DecisionWaitHandshakes> {
    ...
    public static final class DecisionWaitHandshakesEnv {

        public DecisionWaitHandshakesEnv(DecisionWait component, java.util.Map<java.lang.String, org.workcraft.plugins.balsa.handshakestgbuilder.StgInterface> handshakes) {
            ...
            inp = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.array(handshakes, "inp", component.portCount, org.workcraft.plugins.balsa.handshakestgbuilder.ActiveSync.class);
            out = org.workcraft.plugins.balsa.stg.StgHandshakeInterpreter.array(handshakes, "out", component.portCount, org.workcraft.plugins.balsa.handshakestgbuilder.PassiveSync.class);
        }
