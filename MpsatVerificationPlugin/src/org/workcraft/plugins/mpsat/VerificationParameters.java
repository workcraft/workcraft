...
public class VerificationParameters {
    ...
    public static VerificationParameters getToolchainPreparationSettings() {
        return new VerificationParameters("Toolchain preparation of data", VerificationMode.UNDEFINED, 0, null, 0);
    }

    public static VerificationParameters getToolchainCompletionSettings() {
        return new VerificationParameters("Toolchain completion", VerificationMode.UNDEFINED, 0, null, 0);
    }

    public static VerificationParameters getDeadlockSettings() {
        return new VerificationParameters("Deadlock freeness", VerificationMode.DEADLOCK, 0,
    ...
    public static VerificationParameters getDeadlockReachSettings() {
        return new VerificationParameters("Deadlock freeness", VerificationMode.REACHABILITY, 0,
    ...
    public static VerificationParameters getDeadlockWithoutMaximalDummyReachSettings() {
        return new VerificationParameters("Deadlock freeness without maximal dummies", VerificationMode.REACHABILITY, 0,
                MpsatVerificationSettings.getSolutionMode(), MpsatVerificationSettings.getSolutionCount(),
    ...
    public static VerificationParameters getConsistencySettings() {
        return new VerificationParameters("Consistency", VerificationMode.STG_REACHABILITY_CONSISTENCY, 0,
    ...
    public static VerificationParameters getMutexImplementabilitySettings(Mutex mutex) {
        ...
        return new VerificationParameters(propertName, VerificationMode.STG_REACHABILITY, 0,
    ...
    public static VerificationParameters getOutputPersistencySettings(Collection<Pair<String, String>> exceptionPairs) {
        ...
        return new VerificationParameters("Output persistency", VerificationMode.STG_REACHABILITY_OUTPUT_PERSISTENCY, 0,
    ...
    public static VerificationParameters getDiInterfaceSettings() {
        return new VerificationParameters("Delay insensitive interface", VerificationMode.STG_REACHABILITY, 0,
    ...
    public static VerificationParameters getInputPropernessSettings() {
        return new VerificationParameters("Input properness", VerificationMode.STG_REACHABILITY, 0,
    ...
    public static VerificationParameters getConformationSettings(Collection<String> devPlaceRefs) {
        ...
        return new VerificationParameters("Conformation", VerificationMode.STG_REACHABILITY_CONFORMATION, 0,
    ...
    public static VerificationParameters getConformationNwaySettings(Set<String> shadowTransitionNames) {
        ...
        return new VerificationParameters("N-way conformation", VerificationMode.STG_REACHABILITY_CONFORMATION_NWAY, 0,
    ...
    public static VerificationParameters getOutputDeterminacySettings(Collection<String> shadowTransitionRefs) {
        ...
        return new VerificationParameters("Output determinacy", VerificationMode.STG_REACHABILITY_OUTPUT_DETERMINACY, 0,
                MpsatVerificationSettings.getSolutionMode(), MpsatVerificationSettings.getSolutionCount(), reachConformationNway, true);
    }
    ...
    public static VerificationParameters getStrictImplementationReachSettings(Collection<SignalInfo> signalInfos) {
    ...
    public static VerificationParameters getCscSettings() {
        return new VerificationParameters("Complete state coding", VerificationMode.CSC_CONFLICT_DETECTION, 0,
                SolutionMode.ALL, -1 /* unlimited */, null, true);
    }

    public static VerificationParameters getUscSettings() {
        return new VerificationParameters("Unique state coding", VerificationMode.USC_CONFLICT_DETECTION, 0,
                SolutionMode.ALL, -1 /* unlimited */, null, true);
    }

    public static VerificationParameters getNormalcySettings() {
        return new VerificationParameters("Normalcy", VerificationMode.NORMALCY, 0,
                MpsatVerificationSettings.getSolutionMode(), MpsatVerificationSettings.getSolutionCount(),
                null, true);
    }
    ...
    public static VerificationParameters getPlaceRedundancySettings(Collection<String> placeRefs) {
        ...
        return new VerificationParameters("Place redundancy", VerificationMode.REACHABILITY_REDUNDANCY, 0,
                MpsatVerificationSettings.getSolutionMode(), MpsatVerificationSettings.getSolutionCount(), reachPlaceRedundancy, true);
    }

    public static VerificationParameters getEmptyAssertionSettings() {
        return new VerificationParameters("Empty assertion", VerificationMode.ASSERTION, 0,
