...
public class BurstEventSerialiser implements CustomXMLSerialiser<BurstEvent> {
    ...
    @Override
    public void serialise(Element element, BurstEvent object, ReferenceProducer internalReferences, ReferenceProducer externalReferences, NodeSerialiser nodeSerialiser) {
        int dirCounter = 0;
