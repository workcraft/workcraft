...
public class SignalPropertyDescriptors {
    ...
    public final static PropertyDescriptor nameProperty(final VisualXbm visualXbm, final XbmSignal xbmSignal) {
        final Xbm xbm = visualXbm.getMathModel();
        final String propertyName = xbm.getName(xbmSignal) + " name";

        return new PropertyDeclaration<XbmSignal, String>
                (xbmSignal, propertyName, String.class, true, true) {
    ...
    public final static PropertyDescriptor typeProperty(final VisualXbm visualXbm, final XbmSignal xbmSignal) {
        final Xbm xbm = visualXbm.getMathModel();
        final String propertyName = xbm.getName(xbmSignal) + " type";
        return new PropertyDeclaration<XbmSignal, XbmSignal.Type>
                (xbmSignal, propertyName, XbmSignal.Type.class, true, true) {
            @Override
    ...
    public final static PropertyDescriptor valueProperty(final VisualXbm visualXbm, final XbmState targetState, final XbmSignal targetXbmSignal) {
        final Xbm xbm = visualXbm.getMathModel();
    ...
    public final static PropertyDescriptor directionProperty(final VisualXbm visualXbm, final BurstEvent targetBurstEvent, final XbmSignal targetXbmSignal) {
        final Xbm xbm = visualXbm.getMathModel();
