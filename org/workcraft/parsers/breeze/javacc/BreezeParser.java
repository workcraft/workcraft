...
public class BreezeParser implements BreezeParserConstants {
  ...
  final public Token cardinalToken() throws ParseException {
    trace_call("cardinalToken");
    try {
  Token t;
      if (jj_2_52(3)) {
        t = jj_consume_token(CARDINAL);
      } else if (jj_2_53(3)) {
    ...
    throw new Error("Missing return statement in function");
      ...
      trace_return("cardinalToken");
    }
  }

  final public int cardinal() throws ParseException {
    trace_call("cardinal");
    try {
        Token t;
      if (jj_2_54(3)) {
    ...
    throw new Error("Missing return statement in function");
      ...
      trace_return("cardinal");
    }
  }

  final public Expression<Integer> constantCardinalExpression() throws ParseException {
    trace_call("constantCardinalExpression");
    try {
          {if (true) return new Constant<Integer>(cardinal());}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("constantCardinalExpression");
    }
  }
  ...
  final public Expression<String> constantStringExpression() throws ParseException {
    ...
    try {
   {if (true) return new Constant<String>(value());}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public Expression<Integer> cardinalExpression() throws ParseException {
    trace_call("cardinalExpression");
    try {
        Expression<?> result;
      if (jj_2_56(3)) {
    ...
    throw new Error("Missing return statement in function");
      ...
      trace_return("cardinalExpression");
    }
  }
  ...
  final public Expression<Integer> arrayCount() throws ParseException {
    ...
    try {
      jj_consume_token(ZERO);
          {if (true) return cardinalExpression();}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public void registerBreezePart(BreezeLibrary library) throws ParseException {
    trace_call("registerBreezePart");
    try {
        String name;
        List<PortDeclaration> ports;
      ...
      trace_return("registerBreezePart");
    }
  }
  ...
  final public void registerBreezeDef(BreezeLibrary lib) throws ParseException {
    trace_call("registerBreezeDef");
    try {
      if (jj_2_80(3)) {
        typeDefinition();
      } else if (jj_2_81(3)) {
      ...
      trace_return("registerBreezeDef");
    }
  }
  ...
  final public void registerBreezeFile(BreezeLibrary lib) throws ParseException {
    trace_call("registerBreezeFile");
    try {
      label_9:
      while (true) {
        if (jj_2_82(3)) {
      ...
      trace_return("registerBreezeFile");
    }
  }
  ...
  private boolean jj_3_54() {
    if (jj_scan_token(CARDINAL)) return true;
    return false;
  }
