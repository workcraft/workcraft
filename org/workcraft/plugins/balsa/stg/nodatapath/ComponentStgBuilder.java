...
public abstract class ComponentStgBuilder <T> {
	...
	public void buildComponentStg(Component component, Map<String, TwoWayStg> handshakes, StgBuilder builder)
	{
		buildStg((T)component, handshakes, builder);
	}

	public abstract void buildStg(T component, Map<String, TwoWayStg> handshakes, StgBuilder builder);
}