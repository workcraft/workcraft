...
{if ("" != null) return result;}
  ...
  final public BooleanFormula andOp() throws ParseException {boolean inverse = false;
...
{if ("" != null) return inverse ? not(result) : result;}
    throw new Error("Missing return statement in function");
  }

  final public BooleanFormula literal() throws ParseException {Token t;
  BooleanFormula result;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VARIABLE:{
