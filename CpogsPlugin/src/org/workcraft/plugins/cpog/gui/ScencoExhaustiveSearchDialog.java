...
public class ScencoExhaustiveSearchDialog extends JDialog {
	...
	public ScencoExhaustiveSearchDialog(Window owner,
			PresetManager<EncoderSettings> presetManager,
			EncoderSettings settings, WorkspaceEntry we) {
		super(owner, "Exhaustive Search", ModalityType.APPLICATION_MODAL);
	...
	private void createButtonPanel() {
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				settings.setGenerationModeInt(1);
