...
public class CpogExpressionParser implements CpogExpressionParserConstants {
  ...
  final public CpogFormula literal1(String bool) throws ParseException {
  Token t = null;
  CpogFormula result;
  String str = "", exp = "";
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public String boolClose() throws ParseException {
  Token t = null;
  String result;
  ...
  final public String bracketInternals() throws ParseException {
  Token t = null;
  String result = "";
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OVERLAY:
