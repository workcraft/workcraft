...
public class ExportTests {
    ...
    @Test
    public void testVmeExport() throws DeserialisationException, IOException, SerialisationException {
        String vHeader = String.format(
                "// Verilog netlist generated by Workcraft 3%n" +
                "module vme (d, lds, dtack, dsr, dsw, ldtack);%n" +
                "    input dsr, dsw, ldtack;%n" +
                "    output d, lds, dtack;");
