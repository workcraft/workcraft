...
public class PathBreakerClearAllModificationCommand extends PathBreakerAbstractModificationCommand {
    ...
    public Void execute(WorkspaceEntry we) {
        ...
        if (changedContacts.isEmpty()) {
            ...
            LogUtils.logInfo(LogUtils.getTextWithRefs("Path breaker is cleared for pin", refs));
        }
