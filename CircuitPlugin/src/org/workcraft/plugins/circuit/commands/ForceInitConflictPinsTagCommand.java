...
public class ForceInitSelfloopPinsTagCommand extends AbstractTagCommand {

    @Override
    Function<Circuit, Collection<Contact>> getFunction() {
        return circuit -> ResetUtils.tagForceInitSelfloopGates(circuit);
    }

    @Override
    String getMessage() {
        return "Force init self-loop pin";
    }
