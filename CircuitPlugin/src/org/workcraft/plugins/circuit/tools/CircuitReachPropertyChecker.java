...
public class CircuitReachPropertyChecker extends CircuitPropertyChecker {
    ...
    public void run(WorkspaceEntry we) {
        ...
        File presetFile = new File(Framework.SETTINGS_DIRECTORY_PATH, MpsatReachPropertyChecker.MPSAT_REACH_PRESETS_FILE);
