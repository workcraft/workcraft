...
String oldGateName = gateSubstitution.getFirst();
        ...
        {if ("" != null) return new SubstitutionRule(oldGateName, newGateName, portSubstitutions);}
    throw new Error("Missing return statement in function");
    } finally {
...
{if ("" != null) return new Pair(oldName.image, newName.image);}
    throw new Error("Missing return statement in function");
    } finally {
