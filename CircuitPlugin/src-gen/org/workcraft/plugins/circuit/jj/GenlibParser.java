...
public class GenlibParser implements GenlibParserConstants {
  ...
  final public Library parseGenlib() throws ParseException {
    ...
    try {List<Gate> gates;
      gates = parseGates();
{if ("" != null) return new Library(gates);}
...
{if ("" != null) return new Gate(name, function, null, false);}
    throw new Error("Missing return statement in function");
    } finally {
...
{if ("" != null) return new Gate(name, function, next, false);}
    throw new Error("Missing return statement in function");
    } finally {
...
String formula = formulaToken.image.replaceAll("^=", "").replaceAll(";$", "");
        {if ("" != null) return new Function(nameToken.image, formula);}
    throw new Error("Missing return statement in function");
    } finally {
...
{if ("" != null) return ((nextToken == null) ? null : nextToken.image);}
    throw new Error("Missing return statement in function");
    } finally {
