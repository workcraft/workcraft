...
public class PetrifyNetSynthesisHide extends ConversionTool {
	...
	public void run(WorkspaceEntry we) {
		...
		if ( !nameSet.isEmpty() ) {
			...
			final TransformationTask task = new TransformationTask(we, "Net synthesis", new String[] {"-hide", names});
