...
public class PcompResultHandler extends AbstractResultHandler<ExternalProcessOutput> {
    ...
    @Override
    public void handleResult(final Result<? extends ExternalProcessOutput> result) {
        try {
