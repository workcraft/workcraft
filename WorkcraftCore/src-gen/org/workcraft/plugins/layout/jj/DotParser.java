...
{if ("" != null) return t.image;}
  ...
  final public int integer() throws ParseException {Token token;
    token = jj_consume_token(INTEGER);
{if ("" != null) return Integer.parseInt(token.image);}
    throw new Error("Missing return statement in function");
  }

  final public void attr(Map<String, String> attrs) throws ParseException {String name;
  String value = null;
    name = id();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 18:{
...
attrs.put(name, value);
  ...
  final public Map<String, String> attr_list() throws ParseException {Map<String, String> result = new HashMap<String, String>();
    jj_consume_token(20);
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return result;}
  ...
  final public void statement(DotListener listener) throws ParseException {Token name;
