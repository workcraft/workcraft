...
public class EncodingSerialiser implements CustomXMLSerialiser<XbmState> {
    ...
    @Override
    public void serialise(Element element, XbmState object, ReferenceProducer internalReferences, ReferenceProducer externalReferences, NodeSerialiser nodeSerialiser) {
        int counter = 0;
