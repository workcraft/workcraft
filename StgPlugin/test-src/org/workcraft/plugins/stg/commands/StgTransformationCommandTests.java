...
public class StgTransformationCommandTests {
    ...
    private static final String[] TEST_STG_WORKS = {
        "org/workcraft/plugins/stg/celement.stg.work",
        "org/workcraft/plugins/stg/buck.stg.work",
        "org/workcraft/plugins/stg/vme.stg.work",
    };

    private static final String[] COMPRESSED_HANDSHAKE_STG_WORKS = {
        "org/workcraft/plugins/stg/handshakes-2.stg.work",
        "org/workcraft/plugins/stg/handshakes-3.stg.work",
    };
